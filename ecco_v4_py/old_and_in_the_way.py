...
# -*- coding: utf-8 -*-
"""
Created on Fri May 10 14:41:14 2019

routines that were needed when using the ecco v4 r3 original netcdf files
which didn't label axes with *_g
...
#%%        
def load_tile_from_netcdf_old(data_dir, var, var_type, tile_index, 
                          k_subset = [],
